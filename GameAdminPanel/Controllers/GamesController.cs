...
namespace GameAdminPanel.Controllers
{
    public class GamesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Title,Description,ReleaseDate")] Game game)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Description,ReleaseDate")] Game game)
        {
            if (id != game.Id)
            {
                return NotFound();
